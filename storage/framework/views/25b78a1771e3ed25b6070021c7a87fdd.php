    ...
    <div class="swiper-container">
        <div>
            ...
            <section class="islands">
                <img
                    src="<?php echo e(asset('frontend/assets/img/hero.jpg')); ?>"
                    alt=""
                    class="islands__bg"
                />
...
>
    <div class="logos__container container grid">
        <div class="logos__img">
            <img src="<?php echo e(asset('frontend/assets/img/tripadvisor.png')); ?>" alt="" />
        </div>
        <div class="logos__img">
            <img src="<?php echo e(asset('frontend/assets/img/airbnb.png')); ?>" alt="" />
        </div>
        <div class="logos__img">
            <img src="<?php echo e(asset('frontend/assets/img/booking.png')); ?>" alt="" />
        </div>
        <div class="logos__img">
            <img src="<?php echo e(asset('frontend/assets/img/airasia.png')); ?>" alt="" />
        </div>
    </div>
</section>
                        ...
                        <a href="<?php echo e(route('travel_package.show', $travel_package->slug)); ?>">
                            ...
                            <div class="popular__data">
                                <h2 class="popular__price">
                                    <span>$</span><?php echo e(number_format($travel_package->price,2)); ?>

                                </h2>
                                <h3 class="popular__title">
                                    <?php echo e($travel_package->location); ?>
    ...
    <div class="value__container container grid">
        <div class="value__images">
            ...
            <div class="value__img">
                <img src="<?php echo e(asset('frontend/assets/img/team.jpg')); ?>" alt="" />
            </div>
        </div>
            ...
            <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="blog__card">
                    <div class="blog__image">
                        <img
                            src="<?php echo e(Storage::url($blog->image)); ?>"
                            alt=""
                            class="blog__img"
                        />
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PEMWEB LARAVEL\travel-website-laravel\resources\views/homepage.blade.php ENDPATH**/ ?>