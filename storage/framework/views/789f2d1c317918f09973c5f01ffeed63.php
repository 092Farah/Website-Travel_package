        ...
        <div class="swiper-container gallery-top">
          <div class="swiper-wrapper">
            ...
            <section class="islands swiper-slide">
              <img
                src="<?php echo e(asset('frontend/assets/img/contact-hero.jpg')); ?>"
                alt=""
                class="islands__bg"
              />
        ...
        <div class="contact__container container grid">
          <div class="contact__images">
            ...
            <div class="contact__img">
              <img src="<?php echo e(asset('frontend/assets/img/contact.jpg')); ?>" alt="" />
            </div>
          </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PEMWEB LARAVEL\travel-website-laravel\resources\views/contact.blade.php ENDPATH**/ ?>